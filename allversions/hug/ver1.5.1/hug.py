...
while True:
    ...
    z=0
    a=input('你的名字(请写中文):')
    if a=='王翊轩'or a=='孟庆睿' or a=='陈王俊逸' or a=='陈思源' or a=='齐天' or a=='胡涛' or a=='靳博涵' or a=='张泓洋' or a=='刘传鹏' or a=='陈旭阳' or a=='张博涵' or a=='杜圣迪' or a=='罗奕恒' or a=='娄文喆' or a=='栾智翔' or a=='祁子荃' or a=='李佳澍' or a=='伊楠斯':
        gendera=1
    elif a=='刘屹' or a=='刘益同' or a=='武昕冉' or a=='汪妍竹' or a=='王思颖' or a=='刘晓薇' or a=='黄淦欣' or a=='陈奕伽' or a=='吴亭颐' or a=='陈思涵' or a=='刘书彤' or a=='李潇曼' or a=='韩睿' or a=='戴睿' or a=='运涵' or a=='胡泽伊' or a=='田馨雅' or a=='崔玉莹' or a=='赵梓涵' or a=='邵佳琳' or a=='陈露萍' or a=='王泰然' or a=='李欣然' or a=='梅古里':
        gendera=2
    else:
    ...
    if gendera==1 or gendera==2:
        b=input('你想拥抱谁(请写中文):')
        if b=='王翊轩'or b=='孟庆睿' or b=='陈王俊逸' or b=='陈思源' or b=='齐天' or b=='胡涛' or b=='靳博涵' or b=='张泓洋' or b=='刘传鹏' or b=='陈旭阳' or b=='张博涵' or b=='杜圣迪' or b=='罗奕恒' or b=='娄文喆' or b=='栾智翔' or b=='祁子荃' or b=='李佳澍' or b=='刘屹' or b=='刘益同' or b=='武昕冉' or b=='汪妍竹' or b=='王思颖' or b=='刘晓薇' or b=='黄淦欣' or b=='陈奕伽' or b=='吴亭颐' or b=='陈思涵' or b=='刘书彤' or b=='李潇曼' or b=='韩睿' or b=='戴睿' or b=='运涵' or b=='胡泽伊' or b=='田馨雅' or b=='崔玉莹' or b=='赵梓涵' or b=='邵佳琳' or b=='陈露萍' or b=='王泰然' or b=='李欣然' or b=='梅古里' or b=='伊楠斯':      
            genderb=1
            if a!=b:
                d=input('你想对'+b+'说什么?')
            else:
                d=""
            if b=='刘屹' or b=='刘益同' or b=='武昕冉' or b=='汪妍竹' or b=='王思颖' or b=='刘晓薇' or b=='黄淦欣' or b=='陈奕伽' or b=='吴亭颐' or b=='陈思涵' or b=='刘书彤' or b=='李潇曼' or b=='韩睿' or b=='戴睿' or b=='运涵' or b=='胡泽伊' or b=='田馨雅' or b=='崔玉莹' or b=='赵梓涵' or b=='邵佳琳' or b=='陈露萍' or b=='王泰然' or b=='李欣然' or b=='梅古里':
                genderb=2    
            if a==b:
                print(a+"自'抱'自弃")
            else:
                if b=='孟庆睿' and a!='梅古里' and a!='伊楠斯':
                    if a=='武昕冉':
                        print("孟庆睿紧紧地抱住了你")
                        print("他充满爱意地凝视着你")
                        print("他抚摸了一下你的头")
                        ...
                        print("你被狠狠地推开了")
                        y=1
                elif b=='孟庆睿' and a=='梅古里':
                    print("你抱住了创造了你的“上帝”")
                    print("他的初一下学期时的回忆、幻想、心理、人格与你发生了强烈的共鸣")
                elif b=='孟庆睿' and a=='伊楠斯':
                    print("你抱住了创造了你的“上帝”")
                    print("他的初二初三时的回忆、幻想、心理、人格与你发生了强烈的共鸣")
                    ...
                    if a=='梅古里':
                        print("你从水中跑向站在沙滩上看着大海的伊楠斯,扑过去抱住了他")
                        print("你与他紧紧地贴在了一起,可以感知到彼此的心跳在加速")
                        print("他托住你的腰和大腿，用公主抱的姿势把你抱了起来")
                        print("过了一小会儿,他轻轻地把你放在沙滩上,躺在你身旁,拉着你的手")
                        print("你看着辽阔的大海,回忆起今年春夏和他的每一次共处")
                        y=9
                    elif a=='孟庆睿':
                        print("你抱住了你的幻想")
                        print("你的初二初三时的回忆、幻想、心理、人格与他发生了强烈的共鸣")
                    else:
                        print("你撞上了小说与现实之间的次元壁")
                elif b=='梅古里':
                    if a=='伊楠斯':
                        print("梅古里从水中跑向站在沙滩上看着大海的你,扑过去抱住了你")
                        print("你与她紧紧地贴在了一起,可以感知到彼此的心跳在加速")
                        print("你托住她的腰和大腿，用公主抱的姿势把她抱了起来")
                        print("过了一小会儿,你轻轻地把她放在沙滩上,躺在她身旁,拉着她的手")
                        print("你看着辽阔的大海,回忆起今年春夏和她的每一次共处")
                        y=9
                    elif a=='孟庆睿':
                        print("你抱住了你的幻想")
                        print("你的初一下学期时的回忆、幻想、心理、人格与她发生了强烈的共鸣")
                    else:
                        print("你撞上了小说与现实之间的次元壁")
                else:
                    if a=='梅古里' or a=='伊楠斯':
            ...
            d=""
            genderb=0
    if gendera==1 and genderb==1 and a!='梅古里' and a!='伊楠斯' and b!='梅古里' and b!='伊楠斯':
        if b!='孟庆睿':
            print("Are you a gay?")
    if gendera==2 and genderb==2 and a!='梅古里' and a!='伊楠斯' and b!='梅古里' and b!='伊楠斯':
        if a!=b:
            print("Are you a lesbian?")
    if a=='武昕冉' and genderb==1 and b!='孟庆睿' and b!='梅古里' and b!='伊楠斯':
        y=2
        if b=='陈王俊逸':
            z=1                            #下面一行多加了一层括号，修复了一个小BUG(当hugger为刘屹 huggee为伊楠斯时,“太过分了”的turtle效果误触发)
    if ((a=='刘屹' and genderb==1 and b!='陈王俊逸') or (a=='陈王俊逸' and genderb==2 and b!='刘屹')) and a!='梅古里' and a!='伊楠斯' and b!='梅古里' and b!='伊楠斯':
