...
def keyboardChinese(callback):
    ...
    addButton(48, -112, 32, 32, "成", lambda: keyboardPress("成"), COLORS['tui_normal'])
    addButton(96, -112, 32, 32, "我", lambda: keyboardPress("我"), COLORS['tui_normal'])
    addButton(-192, -160, 32, 32, "把", lambda: keyboardPress("把"), COLORS['tui_normal'])
    addButton(-144, -160, 32, 32, "是", lambda: keyboardPress("是"), COLORS['tui_normal'])
    addButton(-96, -160, 32, 32, "欢", lambda: keyboardPress("欢"), COLORS['tui_normal'])
    addButton(-48, -160, 32, 32, "爱", lambda: keyboardPress("爱"), COLORS['tui_normal'])
    addButton(0, -160, 32, 32, "经", lambda: keyboardPress("经"), COLORS['tui_normal'])
    ...
    addButton(96, -240, 128, 64, "重新开始", inputHuggerScreen, COLORS['tui_quit'])
    uiDrawEnd()
    # 上 不 也 了 你 全 喜 完 对 就 已 当 成 我 把 是 欢 爱 经 起
